...
DEFAULT_WORKER_ID_GET = 'worker_id'
DEFAULT_WORK_GROUP_ID_GET = 'work_group_id'
DEFAULT_STATUS_LIST_GET = 'status'
DEFAULT_DATE_GET = 'date'
DEFAULT_DATETIME_INIT_GET = 'datetime_init'
DEFAULT_DATETIME_END_GET = 'datetime_end'
DEFAULT_FORMAT_GET = 'format'
DEFAULT_DAYS_GET = 'days'
...
WORKER_ID_GET = os.getenv('WORKER_ID_GET', DEFAULT_WORKER_ID_GET)
WORK_GROUP_ID_GET = os.getenv('WORK_GROUP_ID_GET', DEFAULT_WORK_GROUP_ID_GET)
STATUS_LIST_GET = os.getenv('STATUS_LIST_GET', DEFAULT_STATUS_LIST_GET)
DATE_GET = os.getenv('DATE_GET', DEFAULT_DATE_GET)
DATETIME_INIT_GET = os.getenv('DATETIME_INIT_GET', DEFAULT_DATETIME_INIT_GET)
DATETIME_END_GET = os.getenv('DATETIME_END_GET', DEFAULT_DATETIME_END_GET)
FORMAT_GET = os.getenv('FORMAT_GET', DEFAULT_FORMAT_GET)
DAYS_GET = os.getenv('DAYS_GET', DEFAULT_DAYS_GET)
