...
export PORT SSL_CERT_FILE SSL_KEY_FILE

# Generar el archivo de configuración de Apache a partir de la plantilla
envsubst '$PORT $SSL_CERT_FILE $SSL_KEY_FILE' < /app/apache-flask.conf.template > /etc/apache2/sites-available/000-default.conf
